...
public partial class MonitoraggioRetePAC2527Context : DbContext
{
    public MonitoraggioRetePAC2527Context()
    {
    }

    public MonitoraggioRetePAC2527Context(DbContextOptions<MonitoraggioRetePAC2527Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__LogEmail__3214EC076C1C20DA");
