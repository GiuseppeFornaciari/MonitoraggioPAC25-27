...
using MonitoraggioRetePAC25_27.Models.DTO;
...
namespace MonitoraggioRetePAC25_27.Controllers
{
    public class OutputController : Controller
    {
        ...
        public OutputController(MonitoraggioRetePAC2527Context context, RoleService roleService, IWebHostEnvironment environment, IConfiguration configuration, AllegatiService allegatiService)
        {
            _context = context;
